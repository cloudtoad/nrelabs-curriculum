...
/usr/bin/qemu-system-x86_64 \
 ...
 -drive if=ide,file=/rhel8.qcow2,index=0 \
 -virtfs local,path=/antidote,security_model=passthrough,mount_tag=antidote \
 -virtfs local,path=/tower,security_model=passthrough,mount_tag=tower \
 -netdev user,id=user,net=10.0.0.0/24,hostfwd=tcp::22-10.0.0.15:22 \
